...
def coingecko():
    ...
    # default price btco-usd
    print(rdata.hset("prices", "coingecko:btco-usd", 1), "Coingecko BTCO-USD", 1)
    # default price btco-btc
    nanoBtc = rdata.hget("prices", "coingecko:nano-btc").decode('utf-8')
    nanoUsd = rdata.hget("prices", "coingecko:nano-usd").decode('utf-8')
    btcoBtc = ("%.8f" % round(float(nanoBtc)/float(nanoUsd), 8))
    print(rdata.hset("prices", "coingecko:btco-btc", btcoBtc), "Coingecko BTCO-BTC", btcoBtc)

coingecko()

print("Coingecko BTCO-USD:", rdata.hget("prices",
                                        "coingecko:btco-usd").decode('utf-8'))
print("Coingecko BTCO-BTC:", rdata.hget("prices",
                                        "coingecko:btco-btc").decode('utf-8'))
